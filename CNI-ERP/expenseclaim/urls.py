...
urlpatterns = [
    ...
    url(r'^ajax_delete_invoice_item/$', views.invoiceItemdelete, name='ajax_delete_invoice_item'),
    ...
    url(r'^expenses-invoice-detail/(?P<pk>[0-9]+)/$', views.ExpenseInvoiceDetailView.as_view(), name='expenses_invoice_detail'),
    ...
    url(r'^ajax_add_invoice_details/$', views.expensesinvoicedetailsadd, name='ajax_add_invoice_details'),
    url(r'^ajax_update_expenses_file/$', views.expensesclaimfilesadd, name='ajax_update_expenses_file'),
    url(r'^ajax_update_invoice_file/$', views.expensesclaiminvoicefilesadd, name='ajax_update_invoice_file'),
    ...
    url(r'^ajax_get_invoice_item/$', views.getInvoiceItem, name='ajax_get_invoice_item'),
    url(r'^ajax_check_receipt_no/$', views.checkReceiptNo, name='ajax_check_receipt_no'),
]
